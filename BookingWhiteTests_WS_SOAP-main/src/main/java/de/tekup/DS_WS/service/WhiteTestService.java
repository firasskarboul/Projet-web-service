...
public class WhiteTestService {
	...
	public WhiteTestResponse checkExam(StudentRequest studentRequest) throws DatatypeConfigurationException
	{
		...
		a1.setCity("Ariena");
		a1.setStreet("rue hbib bourgiba");
		a1.setPosteCode("8050");
		
		Address a2 = new Address();
		a2.setCity("Beja");
		a2.setStreet("Rue becha");
		a2.setPosteCode("9070");
		
		Address a3 = new Address();
		a3.setCity("Sousse");
		a3.setStreet("Rue mourouj");
		a3.setPosteCode("5020");
		
		Address falseAddress = new Address();
		falseAddress.setCity("ERREUR");
		falseAddress.setStreet("ERREUR");
		falseAddress.setPosteCode("ERREUR");
		...
		Student falseStudent = new Student (-1, "erreur",falseAddress);
		Exam falseExam = new Exam ("-1","erreur");
